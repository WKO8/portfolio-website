          ...
          <div className="projects-cards w-full">
            <div className="project-card-0 ml-2">
              ...
              >
                ...
                <div className="project-info w-4/5">
                  <h4 className="text-lg font-bold mb-2">WKO Hub</h4>
                  <p className="text-gray-400 text-sm text-start">
                    A multi-tenant SaaS platform designed to digitize small and
            ...
            <div className="project-card-1 ml-2">
              ...
              >
                <div className="project-image w-1/5 align-middle text-center justify-center mt-2">
                  <Image
                    src="/images/crochetart-logo.png"
                    alt="Crochet Art logo"
                    width="60"
                    height="60"
                    className="rounded-3xl"
                  />
                ...
                <div className="project-info w-4/5">
                  <h4 className="text-lg font-bold mb-2">Crochet&apos;Art</h4>
                  <p className="text-gray-400 text-sm text-start">
                    E-commerce website for a crochet business, a custom
